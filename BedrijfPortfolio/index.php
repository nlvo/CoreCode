    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="motto col-md-12">
                <h1> <i class="fa fa-quote-left"></i> Wij werken tot in de puntjes. <i class="fa fa-quote-right"></i> </h1>
            </div>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="options col-sm-12">
                        <div class="col-sm-3">
                            ...
                            <h1>Ideeën</h1>
                            <p>Heeft u een goed idee? maar hulp nodig heeft met het realiseren ervan. Bij Corecode nemen we u mee met het proces</p>
                        </div>
                        <div class="col-sm-3">
                            <i class="fa fa-code"></i>
                            <h1>Websites</h1>
                            <p>Bent u iemand die een nieuwe website nodig heeft? Of heeft u een verniewend website nodig.</p>
                        </div>
                        <div class="col-sm-3">
                            <i class="fa fa-pencil"></i>
                            <h1>Ontwerp</h1>
                            <p>Bent u op zoek naar iets speciaals? </p>
                        </div>
                        <div class="col-sm-3">
                            <i class="fa fa-users"></i>
                            <h1>Samen</h1>
                            <p>Het kan best lastig zijn om een team te vinden die u idee kan realiseren. Maar wij Corecode nemen u mee met het proces. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <hr>
                        ...
                        <div class="col-sm-6 p4">
                            ...
                            <h3>Lien</h3>
                            <p>Media Developer</p>
                            <p>Hoi, Mijn naam is Lien. Ik ben 18 jaar oud en studeer aan het Media College Amsterdam. En doe de opleiding Media development. Op dit mo....
                        ...
                        <div class="more p4more col-sm-12">
                            ...
                            <h2>Lien Vo</h2>
                            <p>Hoi, Mijn naam is Lien. Ik ben 18 jaar oud en studeer aan het Media College Amsterdam. En doe de opleiding Media Development. Op dit moment zit ik in mijn 3e leerjaar. Mijn focus ligt vooral op het front-end development.
                            <br>
                            <br>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <hr>
                        <div class="options col-sm-12">
                            ...
                            <div class="visitadress col-sm-4">
                        ...
                        <div class="mail">
                            <form id="conForm" method="POST" action="php/mail.php">
                                <h4>Naam</h4>
                            ...
                            <br>
                            <p class="bmore emclose">Anuleer</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
            </div> <!-- contact end-->
