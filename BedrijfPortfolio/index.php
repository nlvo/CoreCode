    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="services col-md-12">
                <h1>Service</h1>
                <hr>
                <div class="servcont col-md-8 col-md-offset-2">
                    <div class="col-sm-3">
                        <i class="fa fa-lightbulb-o"></i>
                        <h2>Ideeën</h2>
                        <p>Heeft u een goed idee? maar hulp nodig om het realiseren ervan. Bij Corecode kunnen we u daarbij helpen.</p>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <h2>Ontwerp</h2>
                        <p>Bent u op zoek naar iets speciaals? maar weet niet zo goed wat? Dan bent u op het goed adres.</p>
                    </div>
                    <div class="col-sm-3">
                        <i class="fa fa-users"></i>
                        <h2>Samen</h2>
                        <p>Het kan best lastig zijn om een team te vinden die u idee kan realiseren. Maar wij bij Corecode nemen u mee met het proces. </p>
                    </div>
                </div>
            </div> <!-- services end -->
